...
die("<script type='text/javascript'>alert('login realizado com sucesso!!'); window.top.location='index.php';</script>");

}else{


die("<script type='text/javascript'>alert('E-mail ou senha não conferem!!'); window.top.location='';</script>");
